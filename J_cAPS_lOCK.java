...
class J_cAPS_lOCK 
{
	public static void main(String[] args) 
	{
        ...
        if (f.compareTo(f.toUpperCase()) == 0) {
            System.out.println(f.toLowerCase());
            
        }else if (f.charAt(0)==f.toLowerCase().charAt(0)&& f.substring(1).compareTo(f.substring(1).toUpperCase())==0) {
            
            f=f.toUpperCase().charAt(0)+f.substring(1).toLowerCase();
